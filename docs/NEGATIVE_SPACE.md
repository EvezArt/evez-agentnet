...
Negative space is the append-only record of what the system cannot currently justify, represent, access, reproduce, or falsify.
...
- What existing claim depends on the missing object?
- What is the smallest reversible experiment?
- What capability would become possible if resolved?
...
The frontier tells the system where knowledge ends; it does not manufacture what lies beyond that boundary.